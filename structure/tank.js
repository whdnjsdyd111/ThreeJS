...
function main() {
    ...
    // 탱크 몸체
    const bodyGeometry = new THREE.BoxGeometry(carWidth, carHeiht, carLength);
    ...
    const wheelPositions = [
        [-carWidth / 2 - wheelThickness / 2, -carHeiht / 2, carLength / 3],
        [carWidth / 2 + wheelThickness / 2, -carHeiht / 2, carLength / 3],
        [-carWidth / 2 - wheelThickness / 2, -carHeiht / 2, 0],
        [carWidth / 2 + wheelThickness / 2, -carHeiht / 2, 0],
        [-carWidth / 2 - wheelThickness / 2, -carHeiht / 2, -carLength / 3],
        [carWidth / 2 + wheelThickness / 2, -carHeiht / 2, -carLength / 3],
    ];
